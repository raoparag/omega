...
public class OmegaTestContainer extends TestContainer {

    public OmegaTestContainer() {
        super();
    ...
    public static class Common extends OmegaTestContainer {

        public static final OmegaTestContainer.Common INSTANCE = new OmegaTestContainer.Common();
